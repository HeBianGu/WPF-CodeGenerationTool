...
namespace CodeAutoGenerationTool.ViewModel
{
    ...
    partial class CodeModelPropertyNotifyClass
    {


        private string _dllPath= @"D:\HealthCottage\Product\Debug\Model.Provider.dll";
        /// <summary> 说明  </summary>
        ...
        private TypeNodeClass _selectItem;
        /// <summary> 说明  </summary>
        public TypeNodeClass SelectItem
        {
    ...
    partial class CodeModelPropertyNotifyClass : INotifyPropertyChanged
    {
        public RelayCommand RelayCommand { get; set; }

        public CodeModelPropertyNotifyClass()
        {
