...
namespace HeBianGu.Control.PropertyGrid
{
  ...
  using Controls;
    ...
    /// </summary>
    public partial class PropertyGrid : System.Windows.Controls.Control, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty LayoutProperty =
         DependencyProperty.Register("Layout", typeof(System.Windows.Controls.Control), ThisType,
        ...
        {
            var layoutContainer = e.NewValue as System.Windows.Controls.Control;
        ...
        public System.Windows.Controls.Control Layout
        {
            get { return (System.Windows.Controls.Control)GetValue(LayoutProperty); }
        ...
        {
            get { return (object)GetValue(BindSelectedObjectProperty); }
            set { SetValue(BindSelectedObjectProperty, value); }
        }

        // Using a DependencyProperty as the backing store for BindSelectedObject.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty BindSelectedObjectProperty =
            DependencyProperty.Register("BindSelectedObject", typeof(object), typeof(PropertyGrid), new PropertyMetadata(null, (l, k) =>
            {
                PropertyGrid control = l as PropertyGrid;

                control.SelectedObject = k.NewValue;
            }));


        public object[] BindSelectedObjects
        {
            get { return (object[])GetValue(BindSelectedObjectsProperty); }
            set { SetValue(BindSelectedObjectsProperty, value); }
        }

        // Using a DependencyProperty as the backing store for BindSelectedObject.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty BindSelectedObjectsProperty =
            DependencyProperty.Register("BindSelectedObjects", typeof(object[]), typeof(PropertyGrid), new PropertyMetadata(null, (l, k) =>
            {
                PropertyGrid control = l as PropertyGrid;

                var result = k.NewValue as object[];

                if (result == null) return;

                control.SelectedObjects = result;
            }));
